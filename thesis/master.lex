...
\begin{center}
    \vspace*{2cm}
    \textbf{\Large Supervisor:} Prof. [Supervisor Name] \\[0.5cm]
    \textbf{\Large Degree:} Master of Science in Computer Engineering
\end{center}
...
I would like to express my sincere gratitude to my supervisor, \textbf{Prof. [Name]}, for their invaluable guidance, patience, and support throughout this research. Their insights were instrumental in shaping the mathematical framework of this thesis.

I also thank my family for their unwavering encouragement and my colleagues in the Computer Engineering department for their helpful discussions and feedback.
...
\begin{enumerate}
    \item To develop a **statistical feature embedding** technique that captures both the magnitude and correlation structure of network traffic.
    \item To formulate a **hybrid anomaly-scoring function** that integrates statistical deviations with deep learning classifier loss.
